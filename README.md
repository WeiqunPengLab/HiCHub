...
```
 ...
 -d : Optional default = 0, the difference to determine whether we keep an edge in cluster analysis (for example, the value of H1ESC-HFFc6 for H1ESC specific hubs), the details could be seen in the paper.  
